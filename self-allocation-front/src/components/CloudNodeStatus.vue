...
//   () => props.deviceData,
//   (newData) => {
//     console.log('CloudNodeStatus 收到的设备数据:', {
//       name: newData.name,
//       ip: newData.ip,
//       metrics: {
...
<template>
  <div
    :class="['cloud-node-status', { 'cloud-node-status--highlight': deviceData.highlight }]"
...
.cloud-node-status {
  ...
  &--highlight {
    ...
    animation: pulseHighlight 0.2s infinite;
  }
